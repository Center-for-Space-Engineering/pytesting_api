...
logger = loggerCustom("logs/KeithSwpAOP1High.txt")
...
@pytest.mark.KeithSwpAOP1High #MAKE SURE TO ADD THE TEST GROUP (PROCEDURE)
def test_keithley_sweeping_AOP1_High(): #MAKE SURE TO HAVE test_ in front of this!
   try :
      logger.send_log(f'Running AOP1 High Gain with Start Current: {StartCurrent} and End Current: {EndCurrent}')
