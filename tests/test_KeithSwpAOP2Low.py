...
logger = loggerCustom("logs/KeithSwpAOP2Low.txt")
...
@pytest.mark.KeithSwpAOP2Low #MAKE SURE TO ADD THE TEST GROUP (PROCEDURE)
def test_keithley_sweeping_AOP2_Low(): #MAKE SURE TO HAVE test_ in front of this!
   try :
      logger.send_log(f'Running AOP2 Low Gain with Start Current: {StartCurrent} and End Current: {EndCurrent}')
