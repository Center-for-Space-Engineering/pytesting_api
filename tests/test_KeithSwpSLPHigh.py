...
StartCurrent = '-0.8e-6' #Keithely start current (A)
EndCurrent = '0.8e-6' #Keithely end current (A)
...
DacWord = '16751' #-2V for SLP High Gain (ion collection)
######################################################

logger = loggerCustom("logs/KeithSwpSLPHigh.txt")
...
@pytest.mark.KeithSwpSLPHigh #MAKE SURE TO ADD THE TEST GROUP (PROCEDURE)
def test_keithley_sweeping_SLPHigh(): #MAKE SURE TO HAVE test_ in front of this!
   try :
