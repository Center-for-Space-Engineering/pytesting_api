...
TableName = 'FBP' #The table we want to pull from for index book-keeping
stopPackets = '07FF' #Leave everything else on (fill up buffer fast)
...
@pytest.mark.KeithSwpSWPFBP #MAKE SURE TO ADD THE TEST GROUP (PROCEDURE)
def test_keithley_sweeping_SWPFBP(): #MAKE SURE TO HAVE test_ in front of this!
   try :
